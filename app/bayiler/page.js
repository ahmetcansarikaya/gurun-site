  ...
  return (
    <div className="container-custom py-12">
      ...
      <div className="mt-12 bg-gray-50 p-8 rounded-lg">
        <h2 className="text-2xl font-semibold mb-4">Bayi Olmak İster misiniz?</h2>
        <p className="text-gray-600 mb-6">
          Kaliteli ürünlerimizi satış noktanızda bulundurmak ve büyüyen ailemize katılmak için bizimle iletişime geçin.
        </p>
