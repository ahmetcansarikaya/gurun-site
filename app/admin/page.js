    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-white rounded-xl shadow-sm p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h2 className="text-sm font-medium text-gray-600">Ürünler</h2>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h2 className="text-sm font-medium text-gray-600">Mesajlar</h2>
              <p className="text-lg font-semibold text-gray-900">{stats.messages}</p>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {quickLinks.map((link) => (
          ...
          >
            <div className="flex items-center">
              <div className={`p-3 rounded-full ${link.color} bg-opacity-10 text-${link.color.split('-')[1]}-600`}>
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
